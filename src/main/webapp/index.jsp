...
<%--<%@ page import="com.example.e_commerproject.DTO.ProductDto" %>--%>
...
<%--                </div>--%>
                ...
                <p>Hello,
                    <a href="login.jsp.jsp" data-dialog="login" data-step="1">Sign In</a> or
<%--                    <a href="SignUpForm.jsp" data-dialog="login" data-step="2">Sign Up</a>--%>
                </p>
            </div>
        </div>
    </div>
